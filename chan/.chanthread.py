...
class Thread(object):
    ...
    def _set_folders(self):
        ...
        self.effective_dump_dir = os.sep.join(
            [self.effective_root_dir, self.dump_dir])

        self.board_dir = os.sep.join([self.effective_dump_dir, self.board])

        self.thread_dir = os.sep.join([self.board_dir, self.chan_thread_id])
    ...
    def _build_folder_tree(self):
        ...
        for f in self.subfolders:
            full_path = "".join([self.thread_dir, f])
